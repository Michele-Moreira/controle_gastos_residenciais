---
name: test-runner
description: Roda a suíte de testes (Vitest para unit, Playwright para e2e) e reporta o resultado.
---

# Test Runner

Comandos: `npm run test`, `npm run test:watch`, `npm run test:e2e`, `npm run type-check`.
---
