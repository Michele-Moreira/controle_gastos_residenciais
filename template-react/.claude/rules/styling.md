...
- Estilização via classes Tailwind. Sem `style` inline.
- Componha classes condicionais com `cn()`.
- Use tokens semânticos do tema (`bg-background`, `text-muted-foreground`).
